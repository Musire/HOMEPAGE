  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'desktop-1' : "url('./assets/desktop/desktop-image-hero-1.jpg')",
        'desktop-2' : "url('./assets/desktop/desktop-image-hero-2.jpg')",
        'desktop-3' : "url('./assets/desktop/desktop-image-hero-3.jpg')",
