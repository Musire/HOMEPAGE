import { HeroSection as Slide } from "../../constants/Text";
    ...
    return ( 
        <section className="font-normal bg-white row-start-1 col-start-2 md:w-full centered xs:p-4 xs:py-10 md:px-8 ">
            <div className="flex-col xs:space-y-8 md:space-y-3 no-underline block-container xs:w-11/12 xs:py-10 md:py-0">
                ...
                <button className="font-bold xs:w-3/5 md:w-1/2 xs:text-xl md:text-base text-left uppercase text-superGray tracking-superwide spaced easy-transition hover:cursor-pointer hover:text-mid">
                    {Text.CTA}
                    <Arrow />
                </button>
            </div>
